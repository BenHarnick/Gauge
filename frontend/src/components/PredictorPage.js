...
export function PredictorPage() {
    ...
    return (_jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-[20rem_1fr]", children: [_jsxs("aside", { className: "space-y-5 rounded-xl border border-slate-200 bg-white p-5 shadow-card", children: [_jsx(Slider, { label: "Age", min: 18, max: 64, value: features.age, onChange: (v) => update("age", v), format: (v) => `${v} years` }), _jsx(Toggle, { label: "Sex", value: features.sex, options: [
